...
public class QueueWithFailover {
    ...
    public String getJob() throws EmptyQueueException {
      ...
      //  throw new UnsupportedOperationException("Not implemented yet.");
        ...
        hiddenJobs.put(job,System.currentTimeMillis()); /// check
        return job;
    ...
    public void returnExpiredJobsToQueue() {
       ...
       // throw new UnsupportedOperationException("Not implemented yet.");
        ...
        for(Map.Entry<String, Long> hiddenJob : hiddenJobs.entrySet()){

            if(currTime-hiddenJob.getValue()>=this.jobTimeout){
                jobsName.add(hiddenJob.getKey());
       ...
       for(String name : jobsName) {
           jobs.offer(name);
           hiddenJobs.remove(name);
       }
